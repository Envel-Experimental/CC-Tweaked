...
/**
 * An instance of {@link AbstractContainerMenu} which provides a computer. You
 * should implement this if you provide
...
public interface ComputerMenu {
    ...
    /**
     * Get the input controller for this container. This should be used when
    ...
    /**
     * Set the current terminal state. This is called on the client when the server
     * syncs a computer's terminal
     * contents.
     *
    ...
    /**
     * Get whether this menu is currently in a read-only state.
     */
